-- Per provar el funcionament d'aquest exemple, cal crear la Base de Dades
-- `BOOK_DB`
-- La qual conté una única taula BOOK_MAST
...
CREATE TABLE IF NOT EXISTS `book_mast` (
  ...
  `dt_of_pub` date NOT NULL DEFAULT '2024-02-16',
